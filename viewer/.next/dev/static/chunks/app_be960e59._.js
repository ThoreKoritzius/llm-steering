...
function ViewerPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ViewerPage.useEffect": ()=>{
            ...
            const loadDefault = {
                "ViewerPage.useEffect.loadDefault": async ()=>{
                    try {
            ...
            }["ViewerPage.useEffect.loadDefault"];
            // Try to load baseline
            const loadDefaultBaseline = {
                "ViewerPage.useEffect.loadDefaultBaseline": async ()=>{
                    try {
            ...
            }["ViewerPage.useEffect.loadDefaultBaseline"];
            // Try to load steering vector
            const loadSteeringVector = {
                "ViewerPage.useEffect.loadSteeringVector": async ()=>{
                    try {
                        const res = await fetch("/steer_vector.json");
                        if (res.ok) {
                            const data = await res.json();
                            setState({
                                "ViewerPage.useEffect.loadSteeringVector": (prev)=>({
                                        ...prev,
                                        steeringVector: data
                                    })
                            }["ViewerPage.useEffect.loadSteeringVector"]);
                            if (data.modelId) {
...
//# sourceMappingURL=app_be960e59._.js.map